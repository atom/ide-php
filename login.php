    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                if ($('#timer').length > 0) {
                    var timer;
                    var compareDate = new Date('Wed Jan 09 2019 00:00:00 +0000');
                    compareDate.setDate(compareDate.getDate() + parseInt('6'));
    ...
    <body>
        <section class="bodyWrapper" onclick="closeCookieBar();">
            ...
            <div class="leftBanner main_banner">
                <a class="various" href="#inline_store_visit" onClick="loginFancyPopUP({cashback: '4,00%', storeName: 'Under Armour', urlKey: 'under-armour-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/85175.gif', itemId: '0', bannerId: '38109', isCbkDay: '0'})" title="Under Armour">
                    <img class="main_sidebanner" width="120" height="400" src="https://static.orangebuddies.nl/image/banners/38109-SkyScraperWrapper.jpg" alt="Under Armour"/>
                </a>
                ...
                <div id="top">
                    <span class="top-usp">
                        <span id="headMsg">
                            ...
                            <A HREF="https://www.cashbackdeals.de/shops/theme/January-Sales">Hier geht's zu den besten Januar Angeboten</A>
                        </span>
                    </span>
                    <!--Nog: 14 dagen 13 uur 5 minuten 6 seconden-->
                    <div id="timer">
                        <span id="still-text">Noch:</span>
                        <span id="days"></span>
                        Tage
                        <span id="hours"></span>
                        Stunden
                    ...
                    <div id="top-subscribe">
                        <span>
                            <a href="javascript:void(0);" class="t-user active">
...
<div>
    <div class="column">
        <ul>
            <li>
                <a target="_blank" href="https://www.cashbackkorting.nl/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/netherlands.jpg" alt="netherlands-flag" title="netherlands-flag">
                    </span>
                    <span>Cashbackkorting.nl
                    <!--Niederlande-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="http://www.cashbackdeals.be/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/belgium.jpg" alt="belgium-flag" title="belgium-flag">
                    </span>
                    <span>Cashbackdeals.be
                    <!--Belgien-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackreduction.fr/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/france.jpg" alt="france-flag" title="france-flag">
                    </span>
                    <span>Cashbackreduction.fr
                    <!--Frankreich-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.de/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/germany.jpg" alt="germany-flag" title="germany-flag">
                    </span>
                    <span>Cashbackdeals.de
                    <!--Deutschland-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbacksparen.at/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/austria.jpg" alt="austria-flag" title="austria-flag">
                    </span>
                    <span>Cashbacksparen.at
                    <!--Österreich-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.ch/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/switzerland.jpg" alt="switzerland-flag" title="switzerland-flag">
                    </span>
                    <span>Cashbackdeals.ch
                    <!--Schweiz-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackrabat.pl/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/poland.jpg" alt="poland-flag" title="poland-flag">
                    </span>
                    <span>Cashbackrabat.pl
                    <!--Polen-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.it/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/italy.jpg" alt="italy-flag" title="italy-flag">
                    </span>
                    <span>Cashbackdeals.it
                    <!--Italien-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackearners.co.uk/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/uk.jpg" alt="uk-flag" title="uk-flag">
                    </span>
                    <span>Cashbackearners.co.uk
                    <!--England-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.se/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/sweden.jpg" alt="sweden-flag" title="sweden-flag">
                    </span>
                    <span>Cashbackdeals.se
                    <!--Schweden-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="http://www.cashbackdeals.es/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/spain.png" alt="spain-flag" title="spain-flag">
                    </span>
                    <span>Cashbackdeals.es
                    <!--Spanien-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.fi/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/finland.png" alt="finland-flag" title="finland-flag"/>
                    </span>
                    <span>Cashbackdeals.fi
                    <!--Finnland-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackearners.com/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/usa.png" alt="usa-flag" title="usa-flag"/>
                    </span>
                    <span>Cashbackearners.com
                    <!--Finnland-->
                    </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackearners.com.au/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/australia.png" alt="australia-flag" title="australia-flag"/>
                    </span>
                    <span>Cashbackearners.com.au</span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackearners.ca/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/Canada.png" alt="canada-flag" title="canada-flag">
                    </span>
                    <span>Cashbackearners.ca </span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.dk/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/denmark.png" alt="denmark-flag" title="denmark-flag"/>
                    </span>
                    <span>Cashbackdeals.dk</span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.cz/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/czech.png" alt="czech-flag" title="czech-flag"/>
                    </span>
                    <span>Cashbackdeals.cz</span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.no/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/norway.jpg" alt="norway-flag" title="norway-flag"/>
                    </span>
                    <span>Cashbackdeals.no</span>
                </a>
            </li>
            <li>
                <a target="_blank" href="https://www.cashbackdeals.pt/">
                    <span>
                        <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/portugal.png" alt="portugal-flag" title="portugal-flag"/>
                    </span>
                    <span>Cashbackdeals.pt</span>
                </a>
            </li>
        </ul>
    </div>
...
<span class="notifi-dd">
    <sapn class="notifi-icon">
        <a href="javascript:void(0)">
            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/notify_bell.png">
        </a>
        <span class="notifi-no">0</span>
    </sapn>
    <div class="notifi-list">
        <ul>
            <li class="no-notifi">Keine neue Benachrichtigungen
                                    </li>
            <li class="notifi-all">
                <span>
                    <a href="/user/notifications.php">Alle Benachrichtigungen anzeigen</a>
                </span>
            </li>
        </ul>
    </div>
...
<span class="top-help">
    <a href="/static/help" class="t-help t-user active">
    ...
    <div>
        <div class="column">
            <ul>
                <li>
                    <a href="/static/faq.php">
                        <i class="fa fa-question-circle"></i>
                        FAQ
                    </a>
                </li>
                <li>
                    <a href="/static/contact.php">
                        <i class="fa fa-comment-o"></i>
                        Anfrage stellen 
                    </a>
                </li>
                <li>
                    <a href="/user/generateticket.php">
                        <i class="fa fa-cart-plus"></i>
                        Antrag für fehlende Transaktion stellen 
                    </a>
                </li>
                <li>
                    <a href="/user/ticket.php">
    ...
    <div id="search">
        ...
        <form method="get" action="/search/search.php" id="frmMainSearch">
            ...
            <div class="searc-selection">
                <button type="button" class="searc-SDD" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fa fa-caret-down"></i>
                </button>
                <div class="searc-SDC" style="">
                    <span class="searc-sel-opt">
                        <label>
                            <input class="searchChkbox" type="checkbox" name="store" value="store" checked onchange="getSearchResults($('#searchinput').val(), 'searchBox', 'search_results.php', '', 'searchChkbox')">Shops
                        </label>
                    </span>
                    <span class="searc-sel-opt">
                        <label>
                            <input class="searchChkbox" type="checkbox" name="deal" value="deal" checked onchange="getSearchResults($('#searchinput').val(), 'searchBox', 'search_results.php', '', 'searchChkbox')">Angebote
                        </label>
                    </span>
                    <span class="searc-sel-opt">
                        <label>
                            <input class="searchChkbox" type="checkbox" name="category" value="category" checked onchange="getSearchResults($('#searchinput').val(), 'searchBox', 'search_results.php', '', 'searchChkbox')">Kategorien
                        </label>
                    </span>
                    <span class="searc-sel-opt">
                        <label>
                            <input class="searchChkbox" type="checkbox" name="faq" value="faq" checked onchange="getSearchResults($('#searchinput').val(), 'searchBox', 'search_results.php', '', 'searchChkbox')">FAQ
                        </label>
                    </span>
                </div>
            </div>
...
<div id="container" class="clearfix">
    <div id="menu">
        <h1 class="heading-1" style="display: none;">
            <a href="https://www.cashbackdeals.de/">Verdiene Geld mit :</a>
        </h1>
        <ul>
            <li>
                ...
                <div>
                    <div class="nav-column">
                        ...
                        <ul>
                            <li>
                                <a href="/shops/category-overview.php?url_key=baby-und-kind">Baby &Kind</a>
                            </li>
                            <li>
                                <a href="/shops/category-overview.php?url_key=bucher-und-zeitschriften">Bücher &Zeitschriften</a>
                            </li>
                            <li>
                                <a href="/shops/category-overview.php?url_key=geschenke-und-gadgets">Geschenke &Gadgets</a>
                            </li>
                            <li>
                                <a href="/shops/category-overview.php?url_key=computer">Elektronik &Unterhaltung</a>
                            </li>
                            <li>
                                <a href="/shops/category-overview.php?url_key=foto-und-kamera">Foto &Kamera</a>
                            </li>
                            <li>
                                <a href="/shops/category-overview.php?url_key=mode">Mode &Fashion</a>
                            </li>
                            <li>
                                <a href="/shops/category-overview.php?url_key=finanzen">Finanzen &Strom</a>
                            </li>
                            <li>
                                <a href="/shops/category-overview.php?url_key=haushalt">Haushalt</a>
                            </li>
                            <li>
                                <a href="/shops/category-overview.php?url_key=games-filme-und-musik">Games, Filme &Musik</a>
                            </li>
                            <li>
                                <a href="/shops/all-categories.php" class="nav-all">Alle Kategorien</a>
                            </li>
                        </ul>
                    </div>
                    <div class="nav-column">
                    ...
                    <div class="nav-column">
                        <h3>
                            <a href="/shops/newshops.php">Neue Shops</a>
                        </h3>
                        <ul>
                            <li>
                                <a href="/cashback/tfbank-de.php">TFBank</a>
                            </li>
                            <li>
                                <a href="/cashback/darlehen-einfach-de.php">darlehen-einfach.de</a>
                            </li>
                            <li>
                                <a href="/cashback/flug-verspaetetde.php">Flug-Verspaetet.de</a>
                            </li>
                            <li>
                                <a href="/cashback/fluege-de.php">fluege.de</a>
                            </li>
                            <li>
                                <a href="/cashback/travelscout24-de.php">TravelScout24</a>
                            </li>
                            <li>
                                <a href="/cashback/viagogo-de.php">viagogo</a>
                            </li>
                            <li>
                                <a href="/cashback/ray-ban-de.php">Ray-Ban</a>
                            </li>
                            <li>
                                <a href="/cashback/klebefieber-de.php">Klebefieber.de</a>
                            </li>
                            <li>
                                <a href="/cashback/finanzcheck-de.php">Finanzcheck.de</a>
                            </li>
                            <li>
                                <a href="/cashback/polo-motorrad-de.php">POLO Motorrad</a>
                            </li>
                            <li>
                                <a class="nav-all" href="/shops/newshops.php">Alle neuen Shops ansehen </a>
                            </li>
                        </ul>
                    </div>
            ...
            <li>
                <a href="/shops/shops.php">Gratis </a>
            </li>
            <li>
                <a href="/static/earn-money.php">Sofort Verdienst</a>
                <div class="nav-small">
                    <!-- please note this extra classs for small submenus -->
                    <div class="nav-column">
                        <ul>
                            <li>
                                <a href="/user/cashmail.php">CashMails </a>
                            </li>
                            <li>
                                <a href="/shops/bannerkliks.php">Bannerklicks </a>
                            </li>
                            <li>
                                <a href="/shops/click-earn-campaigns.php">Klicken und Verdienen </a>
                            </li>
                            <li>
                                <a href="/shops/delen.php">Teilen </a>
                            </li>
                            <li>
                                <a href="/user/inbox-surveys.php">Umfragen </a>
                            </li>
                            <li>
                                <a href="/static/whatsapp.php">WhatsApp </a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <li>
                <a href="/user/cashboost-new.php">Cashboost</a>
                <div class="nav-small">
                    <!-- please note this extra classs for small submenus -->
                    <div class="nav-column">
                        <ul>
                            <li>
                                <a href="/user/detail.php">Profil ergänzen
                                            </a>
                            </li>
                            <li>
                                <a href="/user/cashboost.php">Freunde einladen
                                            </a>
                            </li>
                            <li>
                                <a href="/static/mobile-app.php">App installieren
                                            </a>
                            </li>
                            <li>
                                <a href="/static/toolbar.php">Cashback-Melder downloaden
                                            </a>
                            </li>
                            <li>
                                <a href="/testimonials/add.php">Empfehlung schreiben
                                            </a>
                            </li>
                            <li>
                                <a href="/shops/reviews.php">Online-Shops bewerten
                                            </a>
                            </li>
                            <li>
                                <a href="/static/top-campaigns.php">Top Deals
                                            </a>
                            </li>
                            <li>
                                <a href="/spellen/">Spiele
                                            </a>
                            </li>
                            <li>
                                <a href="/onlinepanel/">Online Panels
                                            </a>
                            </li>
                            <li>
                                <a href="/comparison/">Vergleich
                                            </a>
                            </li>
                        </ul>
                    </div>
            ...
            <li>
                <a href="/shops/win-competition.php">Gewinnen</a>
                <div class="nav-small">
                    <!-- please note this extra classs for small submenus -->
                    <div class="nav-column">
                        <ul>
                            <li>
                                <a href="/user/auction.php">Auktion
                                            </a>
                            </li>
                            <li>
                                <a href="/user/sports-predictions.php">Ergebnis voraussagen
                                            </a>
                            </li>
                            <li>
                                <a href="/user/competitions/">Aktionen/Wettbewerbe
                                            </a>
                            </li>
                            <li>
                                <a href="/user/lottery.php">Lotterie
                                            </a>
                            </li>
                            <li>
                                <a href="/user/jackpot.php">Jackpot
                                            </a>
                            </li>
                            <li>
                                <a href="/user/bingo.php">Bingo
                                            </a>
                            </li>
                            <li>
                                <a href="/user/find-the-code.php">Finde den Code
                                            </a>
                            </li>
                        </ul>
                    </div>
            ...
            <li class="download-app-menu">
                <a class="app-icon" href="/static/mobile-app.php">
            ...
            <li class="download-app-menu">
                <a class="app-icon" href="/static/toolbar.php">
                    <div class="alert-bar">
                        <span>Alert</span>
                    </div>
                </a>
            ...
            <li class="menu-blue">
                <a href="/shops/theme/early-bird-2019">REISEN</a>
            </li>
            <li class="menu-blue">
                <a href="/shops/theme/January-Sales-de">SALES</a>
            </li>
        </ul>
    </div>
    <!--- responseiv menu-->
    <div class="burgermenu">
        <div id="menu_icon">
            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/burger_menu.png" alt="Menu" title="Menu" width="20px" height="16px">Verdiene Geld mit
        </div>
        <div class="resp-app-button">
            <a class="app-icon" href="/static/mobile-app.php">
                <div class="download-app">
                    <span>APP</span>
                </div>
            ...
            <ul class="cd-accordion-menu">
                <li class="has-children">
                    ...
                    <ul>
                        ...
                        <li class="NoSubMenu">
                            <a href="/shops/all-categories.php" target="_self">Alle Kategorien</a>
                        </li>
                        <li class="has-children">
                        ...
                        <li>
                            <a href="/shops/shops.php?url_key=all" target="_self">Alle shops</a>
                        </li>
                        <li class="has-children">
                ...
                <li>
                    <a href="/comparison/" target="_self">Vergleich</a>
                </li>
                <li>
                    <a href="/shops/shops.php" target="_self">Gratis</a>
                </li>
                <li class="has-children">
                ...
                <li>
                    <a href="/shops/theme/early-bird-2019" target="_self">REISEN</a>
                </li>
                <li>
                    <a href="/shops/theme/January-Sales-de" target="_self">SALES</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div id="main">
        <div id="main-content">
            ...
            <div class="QuickLinkBar">
                <ul class="QuickLink">
                    <li>
                        <a href="/user/detail.php" title="Daten">Daten</a>
                    </li>
                    <li>
                        <a href="/user/cashback.php" title="Saldo">Saldo</a>
                    </li>
                    <li>
                        <a href="/user/cashout.php" title="Auszahlen">Auszahlen</a>
                    </li>
                    <li>
                        <a href="/user/cashbackdetails.php" title="Status Auszahlung">Status Auszahlung</a>
                    </li>
                    <li>
                        <a href="/user/favourites.php" title="Favoriten">Favoriten</a>
                    </li>
                    <li>
                        <a href="/user/clicks.php" title="Klickübersicht">Klickübersicht</a>
                    </li>
                    <li>
                        <a href="/user/cashmail-clicks.php" title="Klickübersicht CashMails">Klickübersicht CashMails</a>
                    </li>
                    <li>
                        <a href="/user/ticket.php" title="Hilfe-Tickets">Hilfe-Tickets</a>
                    </li>
                </ul>
            </div>
            <!-- Quick link -->
            <div id="account-block">
                <span class="account-block-1">
                    ...
                    <span class="account-block-subtext">
                        <a href="/user/cashmail.php">
                            <span class="account-number">57</span>
                            Ungelesene CashMails
                        </a>
                        <a href="/shops/delen.php">
                        ...
                        <a href="/shops/click-earn-campaigns.php">
                            <span class="account-number">4</span>
                ...
                <span class="account-block-2">
                    <span class="account-block-amount">
                        <i class="fa fa-user"></i>
                        <span class="account-number-large">100%</span>
                        Profildaten
                    </span>
                    ...
                    <span class="account-block-subtext">
                        <a href="/user/detail.php">Profildaten pflegen</a>
                    </span>
                    <span class="account-block-subtext">
                        <a href="/onlinepanel/">Melde dich für den Online Panel an</a>
                    </span>
                </span>
                <span class="account-block-3">
                    <span class="account-block-amount">
                        <i class="fa fa-database"></i>
                        <span class="account-number-large">19,98</span>
                        CashCoins
                    </span>
                    <span class="progress-meter">
                        <div class="meter">
                    ...
                    <span class="account-block-subtext">
                        <a href="/user/cashout.php">Noch 5,02 bis zur nächsten Auszahlung</a>
                    </span>
                </span>
                    ...
                    <span class="account-block-subtext">
                        <div class="random">
                            <a href="/user/cashboost.php">
                                <span class="account-number">0</span>
                                Freunde
                        ...
                        <div>
                            <a href="/user/auction.php">
                                <span>Jetzt bei der Auktion mitbieten</span>
                            </a>
                        </div>
                        <div class="random">
            ...
            <div id="main-content">
                <div id="home-top" class="clearfix">
                            ...
                            <div class="bx-wrapper">
                                <div class="bx-viewport">
                                    <div class="bxslider-cbkslider">
                                        <div>
                                            <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '4,00%', storeName: 'Under Armour', urlKey: 'under-armour-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/85175.gif', itemId: '0', bannerId: '38106', isCbkDay: '0'})">
                                            ...
                                            <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '4,00%', storeName: 'Under Armour', urlKey: 'under-armour-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/85175.gif', itemId: '0', bannerId: '38106', isCbkDay: '0'})">
                                                <img style="width: 684px; height: 180px;" src="https://static.orangebuddies.nl/image/banners/38106-Slider720x200.jpg" alt="Under Armour"/>
                                            </a>
                                        </div>
                                        <div>
                                            <a href="https://www.cashbackdeals.de/shops/theme/January-Sales-de">
                                                <img style="width: 684px; height: 180px;" src="https://static.orangebuddies.nl/image/banners/37763-Slider720x200.jpg" alt="Home-Banner"/>
                                            </a>
                                        </div>
                                        <div>
                                            <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '5,00%', storeName: 'dress-for-less', urlKey: 'dress-for-less', imgUrl: 'https://static.orangebuddies.nl/image/stores/46864.jpg', itemId: '0', bannerId: '38097', isCbkDay: '0'})">
                                                <div class="DynOverlay" style="visibility: visible;">
                                                    <div class="DynOverlayContent" style="visibility: visible;">
                                                        <div class="OverlayBtn" style="visibility: visible;">
                                                            <span class="bannerLinK">ERHALTE  5,00% CASHCOINS
                                                                </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '5,00%', storeName: 'dress-for-less', urlKey: 'dress-for-less', imgUrl: 'https://static.orangebuddies.nl/image/stores/46864.jpg', itemId: '0', bannerId: '38097', isCbkDay: '0'})">
                                                <img style="width: 684px; height: 180px;" src="https://static.orangebuddies.nl/image/banners/38097-Slider720x200.jpg" alt="dress-for-less"/>
                                            </a>
                                        </div>
                                        <div>
                                            <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '17,50 ', storeName: 'Santander Consumer Bank', urlKey: 'santander-consumer-bank-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/96620.jpg', itemId: '0', bannerId: '38115', isCbkDay: '1'})">
                                                <div class="DynOverlay" style="visibility: visible;">
                                                    <div class="DynOverlayContent" style="visibility: visible;">
                                                        <div class="OverlayBtn" style="visibility: visible;">
                                                            <span class="bannerLinK">ERHALTE BIS ZU 17,50  CASHCOINS
                                                                </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '17,50 ', storeName: 'Santander Consumer Bank', urlKey: 'santander-consumer-bank-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/96620.jpg', itemId: '0', bannerId: '38115', isCbkDay: '1'})">
                                                <img style="width: 684px; height: 180px;" src="https://static.orangebuddies.nl/image/banners/38115-Slider720x200.jpg" alt="Santander Consumer Bank"/>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="homehome-banners clearfix">
                        <ul class="tab">
                            <li>
                                <a href="javascript:void(0)" class="tablinks tablinksNew" id='trending' onclick="openHomeTabs(event, 'Trending')">Doppeltes Cashback</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="tablinks tablinksNew" onclick="openHomeTabs(event, 'Cashbackday')" id="defaultOpen">Cashback des Tages</a>
                            </li>
                        </ul>
                        <div id="Trending" class="tabcontent" id="defaultOpen">
                            <div class="dblCashback">
                                <div class="dblCashbackItem" style="width: 200px !important;">
                                    <center>
                                        <a href="/cashback/clevertronic-de.php">
                                            <img src="https://static.orangebuddies.nl/image/stores/88730.jpg" width="120" height="60" alt="Clevertronic.de" title="Clevertronic.de">
                                        </a>
                                        <div class="oldCash">
                                            <span class="lineThrough">1,75%</span>
                                            <br>3,50%
                                        </div>
                                        <div class="CashBtn">
                                            <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '3,50%', storeName: 'Clevertronic.de', urlKey: 'clevertronic-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/88730.jpg', isCbkDay: '1'})">Erhalte bis zu 3,50% CashCoins</a>
                                        </div>
                                        <div class="counterClock clokctner-0" data-stopdate="2019-01-15 00:00:00">2019-01-15 00:00:00</div>
                                    </center>
                                </div>
                            </div>
                        </div>
                        <div id="Cashbackday" class="tabcontent">
                            <div class="CashBackDay">
                                <a href="/cashback/rau-cosmetics.php">
                                    <img src="https://static.orangebuddies.nl/image/stores/99220.jpg" width="120" height="60" alt="RAU Cosmetics" title="RAU Cosmetics">
                                </a>
                                <div class="oldCash">
                                    <span class="lineThrough">10,00%</span>
                                    <br>15,00%
                                </div>
                                <div class="CashBtn">
                                    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '15,00%', storeName: 'RAU Cosmetics', urlKey: 'rau-cosmetics', imgUrl: 'https://static.orangebuddies.nl/image/stores/99220.jpg', isCbkDay: '1'})">Erhalte  15,00% CashCoins</a>
                                </div>
                                <div id="counterClock" data-stopdate="2019-01-15 00:00:00">2019-01-15 00:00:00</div>
                            </div>
                        </div>
                    </div>
                    <!-- End Banners -->
                ...
                <div class="PopularLogsLink">
                    <a href="/shops/shops.php?url_key=all">+3340 andere Shops ></a>
                </div>
                            ...
                            <ul>
                                ...
                                <li class="no2">
                                    <a href="/user/cashboost.php">
                                        ...
                                        <span class="earn-li-descr">Freunde einladen</span>
                                        <span class="earn-li-detail">Sichere dir 5,00 CashCoins und 10% der Umsätze deiner Freunde.</span>
                                    </a>
                                </li>
                                <li class="no3">
                                    <a href="/static/mobile-app.php">
                                        ...
                                        <span class="earn-li-descr">App installieren</span>
                                        <span class="earn-li-detail">7 Tage die iOS- oder Android-App nutzen und 0,20 CashCoins sichern.</span>
                                    </a>
                                </li>
                                <li class="no4">
                                    <a href="/static/toolbar.php">
                                        ...
                                        <span class="earn-li-descr">Cashback-Melder downloaden</span>
                                        <span class="earn-li-detail">Verpasse nie mehr einen Ankauf mit Cashback auf CashbackDeals.de!</span>
                                    </a>
                                </li>
                                <li class="no5">
                                    <a href="/testimonials/add.php">
                                        ...
                                        <span class="earn-li-descr">Empfehlung schreiben</span>
                                        <span class="earn-li-detail">Erfahrungen zu CashbackDeals.de teilen und erhalte 0,50 CashCoins sichern.</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <span class="home-readmore">
                            <a href="/user/cashboost-new.php">Alle Möglichkeiten</a>
                        </span>
                    </div>
                    <!-- Exclusive Stores -->
                    <div class="home-part">
                        ...
                        <div class="cat-list nonumber home-block">
                            ...
                            <ul>
                                <li class="no1">
                                    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '5,00%', storeName: 'NA-KD.com', urlKey: 'na-kd-com', imgUrl: 'https://static.orangebuddies.nl/image/stores/78132.jpg', isCbkDay: '0'})">
                                        <span class="logo-div2">
                                            <img src="https://static.orangebuddies.nl/image/stores/78132.jpg" alt="NA-KD.com"/>
                                            <span>5,00% CashCoins</span>
                                        </span>
                                        <strong>Entdecke die NA-KD Sale und sichere dir große...</strong>
                                    </a>
                                </li>
                                <li class="no2">
                                    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '91,00 ', storeName: 'Vodafone (DSL, LTE & TV)', urlKey: 'vodafone-dsl', imgUrl: 'https://static.orangebuddies.nl/image/stores/7710.jpg', isCbkDay: '1'})">
                                        <span class="logo-div2">
                                            <img src="https://static.orangebuddies.nl/image/stores/7710.jpg" alt="Vodafone (DSL, LTE & TV)"/>
                                            <span>bis zu 91,00  CashCoins</span>
                                        </span>
                                        <strong>GigaTV ist Deine beste Unterhaltung auf einer...</strong>
                                    </a>
                                </li>
                                <li class="no3">
                                    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '37,50 ', storeName: 'blau Mobilfunk', urlKey: 'blau-mobilfunk-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/90634.jpg', isCbkDay: '1'})">
                                        <span class="logo-div2">
                                            <img src="https://static.orangebuddies.nl/image/stores/90634.jpg" alt="blau Mobilfunk"/>
                                            <span>bis zu 37,50  CashCoins</span>
                                        </span>
                                        <strong>Alles was du brauchst: Entdecke jetzt die Top...</strong>
                                    </a>
                                </li>
                                <li class="no4">
                                    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '20,00%', storeName: 'NordVPN', urlKey: 'nord-vpn-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/95118.jpg', isCbkDay: '0'})">
                                        <span class="logo-div2">
                                            <img src="https://static.orangebuddies.nl/image/stores/95118.jpg" alt="NordVPN"/>
                                ...
                                <li class="no5">
                                    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '17,50 ', storeName: 'AGILA', urlKey: 'agila', imgUrl: 'https://static.orangebuddies.nl/image/stores/79546.gif', isCbkDay: '1'})">
                                        <span class="logo-div2">
                                            <img src="https://static.orangebuddies.nl/image/stores/79546.gif" alt="AGILA"/>
                                            <span>bis zu 17,50  CashCoins</span>
                                        </span>
                                        <strong>Gehe auf Nummer sicher mit der...</strong>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <span class="home-readmore">
                            <a href="/shops/deals.php">Sieh dir weitere beliebte Aktionen an</a>
                        </span>
                    ...
                    <div class="home-part right">
                        ...
                        <div class="cat-list nonumber home-block">
                            ...
                            <ul>
                                ...
                                <li class="no3">
                                    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '17,50 ', storeName: 'Eco24', urlKey: 'eco-24', imgUrl: 'https://static.orangebuddies.nl/image/stores/25160.gif', isCbkDay: '0'})">
                                        <span class="logo-div2">
                                            <img src="https://static.orangebuddies.nl/image/stores/25160.gif" alt="Eco24"/>
                                            <span>2,00  CashCoins</span>
                                        </span>
                                        <strong>Gegründet wurde die Eco24 GmbH im Jahre 2004 als professionelle Schuldenhilfe mit Komplettservice. Sie versuchen,...</strong>
                                    </a>
                                </li>
                                <li class="no4">
                                ...
                                <li class="no5">
                                    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '17,50 ', storeName: 'EntscheiderClub', urlKey: 'entscheiderclub', imgUrl: 'https://static.orangebuddies.nl/image/stores/25301.gif', isCbkDay: '0'})">
                                        <span class="logo-div2">
                                            <img src="https://static.orangebuddies.nl/image/stores/25301.gif" alt="EntscheiderClub"/>
                                            <span>0,15  CashCoins</span>
                                        </span>
                                        <strong>Nur, wer die Wünsche seiner Kunden kennt, kann darauf eingehen. Deswegen wurde der EntscheiderClub ins Leben gerufen. Nimm...</strong>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <span class="home-readmore">
                            <a href="/shops/shops.php">Weitere beliebte kostenlose Aktionen</a>
                        </span>
                        <!-- CHANGED: insert a readmore span/link here -->
                    </div>
                    <!-- End Item Lists -->
                ...
                <div class="shop-category-deals   shop-category-deals-counter  ">
                    ...
                    <div class="exclusive_box  deal-box">
                        <a href="/kortingsactie/design-bestseller-de/design-bestseller-de-versandkostenfrei-bestellen">
                            <div class="exclusivedeal">
                                <div class="productdiscount storeDealz">6,50% CashCoins</div>
                                <img src='https://static.orangebuddies.nl/image/vouchers/v_504068.jpg' alt='design-bestseller.de' width="200" height="85"/>
                            </div>
                        </a>
                        <div class="vs-logo">
                            <img src="https://static.orangebuddies.nl/image/stores/30848.jpg">
                        </div>
                        <div class="deal-countdown" id="dcounter-0" data-stopdate="0000-00-00 00:00:00">
                            Nur noch ...<span id="dcounter-0-daysleft"></span>
                            Tage <span id="dcounter-0-timeleft"></span>
                        </div>
                        <div class="exclusivedescr deal-box-desc">
                            <div>design-bestseller.de schenkt dir die Versandkosten </div>
                        </div>
                        <a class="various button" href='#inline_store_visit' onclick="loginFancyPopUP({cashback: '6,50%', storeName: 'design-bestseller.de', urlKey: 'design-bestseller-de', itemId: '504068' , imgUrl: 'https://static.orangebuddies.nl/image/stores/30848.jpg', isCbkDay: '0'})">
                            <span>Zur Aktion</span>
                        </a>
                    </div>
                    <div class="exclusive_box  deal-box">
                        <a href="/kortingsactie/dell-de/dell-de-kostenloser-versand">
                            <div class="exclusivedeal">
                                <div class="productdiscount storeDealz">2,00% CashCoins</div>
                                <img src='https://static.orangebuddies.nl/image/vouchers/v_504076.jpg' alt='Dell' width="200" height="85"/>
                            </div>
                        </a>
                        <div class="vs-logo">
                            <img src="https://static.orangebuddies.nl/image/stores/64148.jpg">
                        </div>
                        <div class="deal-countdown" id="dcounter-1" data-stopdate="0000-00-00 00:00:00">
                            Nur noch ...<span id="dcounter-1-daysleft"></span>
                            Tage <span id="dcounter-1-timeleft"></span>
                        </div>
                        <div class="exclusivedescr deal-box-desc">
                            <div>Sichere dir kostenlosen Versand für alle Produkte bei Dell </div>
                        </div>
                        <a class="various button" href='#inline_store_visit' onclick="loginFancyPopUP({cashback: '2,00%', storeName: 'Dell', urlKey: 'dell-de', itemId: '504076' , imgUrl: 'https://static.orangebuddies.nl/image/stores/64148.jpg', isCbkDay: '0'})">
                            <span>Zur Aktion</span>
                        </a>
                    </div>
                    <div class="exclusive_box  deal-box">
                        ...
                        <div class="deal-countdown" id="dcounter-2" data-stopdate="0000-00-00 00:00:00">
                            Nur noch ...<span id="dcounter-2-daysleft"></span>
                            Tage <span id="dcounter-2-timeleft"></span>
                        </div>
                        <div class="exclusivedescr deal-box-desc">
                    ...
                    <div class="exclusive_box  deal-box">
                        ...
                        <div class="deal-countdown" id="dcounter-3" data-stopdate="0000-00-00 00:00:00">
                            Nur noch ...<span id="dcounter-3-daysleft"></span>
                            Tage <span id="dcounter-3-timeleft"></span>
                        </div>
                        <div class="exclusivedescr deal-box-desc">
                    ...
                    <div class="exclusive_box  deal-box">
                        ...
                        <div class="deal-countdown" id="dcounter-4" data-stopdate="0000-00-00 00:00:00">
                            Nur noch ...<span id="dcounter-4-daysleft"></span>
                            Tage <span id="dcounter-4-timeleft"></span>
                        </div>
                        <div class="exclusivedescr deal-box-desc">
                    ...
                    <div class="exclusive_box  deal-box">
                        <a href="/kortingsactie/lidl/lidl-sichere-dir-deine-20-rabatt-auf-fotos-de">
                            <div class="exclusivedeal">
                                <div class="productdiscount storeDealz">bis zu 35,00% CashCoins</div>
                                <img src='https://static.orangebuddies.nl/image/vouchers/v_387002.jpg' alt='Lidl' width="200" height="85"/>
                            </div>
                        </a>
                        <div class="vs-logo">
                            <img src="https://static.orangebuddies.nl/image/stores/56432.jpg">
                        </div>
                        <div class="deal-countdown" id="dcounter-5" data-stopdate="2019-01-31 00:00:00">
                            Nur noch ...<span id="dcounter-5-daysleft"></span>
                            Tage <span id="dcounter-5-timeleft"></span>
                        </div>
                        <div class="exclusivedescr deal-box-desc">
                            <div>Lidl: Sichere dir deine 20% Rabatt auf Fotos </div>
                        </div>
                        <a class="various button" href='#inline_store_visit' onclick="loginFancyPopUP({cashback: '35,00%', storeName: 'Lidl', urlKey: 'lidl', itemId: '498012' , imgUrl: 'https://static.orangebuddies.nl/image/stores/56432.jpg', isCbkDay: '1'})">
                            <span>Zur Aktion</span>
                        </a>
                        <div class="shareIconsToggle">
                            <a class="tellfriend" href="#inline_tellafriends" onClick="loadPopup('.tellfriend', '800', '550', 'tellafriends');
                    showTellafriendForm();">
                                <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-mail-small.png" alt="Teilen:"/>
                            </a>
                            <a href="#" onClick="javascript: NewWinScrolls('http://twitter.com/share?url=https://www.cashbackdeals.de/u/481925/cashback/lidl.php&text=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 35,00% CashCoins bei Lidl. Verdiene extra Geld und bekomme direkt 7,50 CashCoins.'), 'Share on Twitter', 600, 450);
                return false;">
                            ...
                            <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/lidl.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 35,00% CashCoins bei Lidl.') + '&picture=https://static.orangebuddies.nl/image/stores/56432.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                    ...
                    <div class="exclusive_box  deal-box">
                        <a href="/kortingsactie/deutsche-postbank/postbank-kontofuehrungsentgelt-de">
                            <div class="exclusivedeal">
                                <div class="productdiscount storeDealz">bis zu 63,50  CashCoins</div>
                                <img src='https://static.orangebuddies.nl/image/vouchers/v_503404.jpg' alt='Postbank' width="200" height="85"/>
                            </div>
                        </a>
                        <div class="vs-logo">
                            <img src="https://static.orangebuddies.nl/image/stores/8164.jpg">
                        </div>
                        <div class="deal-countdown" id="dcounter-6" data-stopdate="2019-01-31 00:00:00">
                            Nur noch ...<span id="dcounter-6-daysleft"></span>
                            Tage <span id="dcounter-6-timeleft"></span>
                        </div>
                        <div class="exclusivedescr deal-box-desc">
                            <div>Jetzt 6 Monate ohne Kontoführungsentgelt bei der Postbank </div>
                        </div>
                        <a class="various button" href='#inline_store_visit' onclick="loginFancyPopUP({cashback: '63,50 ', storeName: 'Postbank', urlKey: 'deutsche-postbank', itemId: '503404' , imgUrl: 'https://static.orangebuddies.nl/image/stores/8164.jpg', isCbkDay: '1'})">
                            <span>Zur Aktion</span>
                        </a>
                        <div class="shareIconsToggle">
                            <a class="tellfriend" href="#inline_tellafriends" onClick="loadPopup('.tellfriend', '800', '550', 'tellafriends');
                ...
                return false;">
                    ...
                    <div class="exclusive_box  deal-box">
                        <a href="/kortingsactie/asos-de/asos-rabatt-50-sale">
                            <div class="exclusivedeal">
                                <div class="productdiscount storeDealz">bis zu 6,00% CashCoins</div>
                                <img src='https://static.orangebuddies.nl/image/vouchers/v_516981.jpg' alt='ASOS' width="200" height="85"/>
                            </div>
                        </a>
                        <div class="vs-logo">
                            <img src="https://static.orangebuddies.nl/image/stores/77259.jpg">
                        </div>
                        <div class="deal-countdown" id="dcounter-7" data-stopdate="2019-01-31 00:00:00">
                            Nur noch ...<span id="dcounter-7-daysleft"></span>
                            Tage <span id="dcounter-7-timeleft"></span>
                        </div>
                        <div class="exclusivedescr deal-box-desc">
                            <div>Sichere dir bis zu 50% Rabatt im Sale von ASOS </div>
                        </div>
                        <a class="various button" href='#inline_store_visit' onclick="loginFancyPopUP({cashback: '6,00%', storeName: 'ASOS', urlKey: 'asos-de', itemId: '516981' , imgUrl: 'https://static.orangebuddies.nl/image/stores/77259.jpg', isCbkDay: '1'})">
                            <span>Zur Aktion</span>
                        </a>
                        <div class="shareIconsToggle">
                            <a class="tellfriend" href="#inline_tellafriends" onClick="loadPopup('.tellfriend', '800', '550', 'tellafriends');
                    showTellafriendForm();">
                            ...
                            <a href="#" onClick="javascript: NewWinScrolls('http://twitter.com/share?url=https://www.cashbackdeals.de/u/481925/cashback/asos-de.php&text=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 6,00% CashCoins bei ASOS. Verdiene extra Geld und bekomme direkt 7,50 CashCoins.'), 'Share on Twitter', 600, 450);
                return false;">
                                <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-twitter-small.png" alt="Auf Twitter teilen"/>
                            </a>
                            <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/asos-de.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 6,00% CashCoins bei ASOS.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                            </a>
                        </div>
                    ...
                    <div class="more-link">
                        <a href="/shops/deals.php">Alle Angebote</a>
                    </div>
                    <!-- CHANGED: insert a readmore span/link here -->
                </div>
                <!-- end deals -->
                ...
                return false;">
                                        ...
                                        <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/groupon-shopping.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 7,50% CashCoins bei Groupon Shopping.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                                        </a>
                                    </div>
                ...
                return false;">
                                        ...
                                        <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/aquadea.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 0,00% CashCoins bei Aquadea.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                                        </a>
                                    </div>
                        ...
                        <li>
                            <div class="dailydeal_box ">
                                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '1,13%', storeName: 'Bax-shop.de', urlKey: 'bax-shop-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/30280.jpg', itemId: '6866006', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span class="dailydeal">
                                ...
                                <a class="various button" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '1,13%', storeName: 'Bax-shop.de', urlKey: 'bax-shop-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/30280.jpg', itemId: '6866006', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span>1,13% extra CashCoins</span>
                                </a>
                                <div class="shareWraperToggle">
                                    <div class="shareIconsToggle">
                                        <a class="tellfriend" href="#inline_tellafriends" onClick="loadPopup('.tellfriend', '800', '550', 'tellafriends');
                    showTellafriendForm();">
                                        ...
                                        <a href="#" onClick="javascript: NewWinScrolls('http://twitter.com/share?url=https://www.cashbackdeals.de/u/481925/cashback/bax-shop-de.php&text=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 1,13% CashCoins bei Bax-shop.de. Verdiene extra Geld und bekomme direkt 7,50 CashCoins.'), 'Share on Twitter', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-twitter-small.png" alt="Auf Twitter teilen"/>
                                        </a>
                                        <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/bax-shop-de.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 1,13% CashCoins bei Bax-shop.de.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                                        </a>
                                    </div>
                        ...
                        <li>
                            <div class="dailydeal_box ">
                                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '3,25%', storeName: 'Bianco', urlKey: 'bianco', imgUrl: 'https://static.orangebuddies.nl/image/stores/30542.jpg', itemId: '6975458', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span class="dailydeal">
                                        <img src="https://orangebuddies.vault.ecloud.co.uk/dailydeals/6975458.jpeg" alt="dagdeal"/>
                                    </span>
                                </a>
                                <div class="price-bg">
                                    <span>€129,99
                                ...
                                <p>BIANCO Adrian Leder Schnür Stiefel Herren Braun</p>
                                <a class="various button" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '3,25%', storeName: 'Bianco', urlKey: 'bianco', imgUrl: 'https://static.orangebuddies.nl/image/stores/30542.jpg', itemId: '6975458', itemType: 'dailydeal', isCbkDay: '0'})">
                ...
                return false;">
                                        ...
                                        <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/bianco.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 3,25% CashCoins bei Bianco.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                                        </a>
                                    </div>
                ...
                return false;">
                                        ...
                                        <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/gearbest.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 0,50% CashCoins bei GearBest.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                                        </a>
                                    </div>
                        ...
                        <li>
                            <div class="dailydeal_box ">
                                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '3,85%', storeName: 'Desigual', urlKey: 'desigual', imgUrl: 'https://static.orangebuddies.nl/image/stores/33825.jpg', itemId: '5587966', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span class="dailydeal">
                                        <img src="https://orangebuddies.vault.ecloud.co.uk/dailydeals/5587966.jpeg" alt="dagdeal"/>
                                    </span>
                                </a>
                                <div class="price-bg">
                                    <span></span>
                                ...
                                <span class="store-logo">
                                    <img src="https://static.orangebuddies.nl/image/stores/33825.jpg" alt="Desigual" width="120" height="60"/>
                                </span>
                                <p>Desigual - unisex - Weißes Tuch - Colour IT - Colour It - Size 240x280-Pack</p>
                                <a class="various button" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '3,85%', storeName: 'Desigual', urlKey: 'desigual', imgUrl: 'https://static.orangebuddies.nl/image/stores/33825.jpg', itemId: '5587966', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span>3,85% extra CashCoins</span>
                                </a>
                                <div class="shareWraperToggle">
                                    <div class="shareIconsToggle">
                                        <a class="tellfriend" href="#inline_tellafriends" onClick="loadPopup('.tellfriend', '800', '550', 'tellafriends');
                    showTellafriendForm();">
                                        ...
                                        <a href="#" onClick="javascript: NewWinScrolls('http://twitter.com/share?url=https://www.cashbackdeals.de/u/481925/cashback/desigual.php&text=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 3,85% CashCoins bei Desigual. Verdiene extra Geld und bekomme direkt 7,50 CashCoins.'), 'Share on Twitter', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-twitter-small.png" alt="Auf Twitter teilen"/>
                                        </a>
                                        <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/desigual.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 3,85% CashCoins bei Desigual.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                                        </a>
                                    </div>
                        ...
                        <li>
                            <div class="dailydeal_box ">
                                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '5,00%', storeName: 'Deal Banana', urlKey: 'deal-banana-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/50836.jpg', itemId: '7008118', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span class="dailydeal">
                                        <img src="https://orangebuddies.vault.ecloud.co.uk/dailydeals/7008118.jpg" alt="dagdeal"/>
                                    </span>
                                </a>
                                <div class="price-bg">
                                    <span>€19,95
                                ...
                                <span class="store-logo">
                                    <img src="https://static.orangebuddies.nl/image/stores/50836.jpg" alt="Deal Banana" width="120" height="60"/>
                                </span>
                                <p>Anti-Rutsch-Klebeband</p>
                                <a class="various button" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '5,00%', storeName: 'Deal Banana', urlKey: 'deal-banana-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/50836.jpg', itemId: '7008118', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span>5,00% extra CashCoins</span>
                                </a>
                                <div class="shareWraperToggle">
                                    <div class="shareIconsToggle">
                                        <a class="tellfriend" href="#inline_tellafriends" onClick="loadPopup('.tellfriend', '800', '550', 'tellafriends');
                    showTellafriendForm();">
                                        ...
                                        <a href="#" onClick="javascript: NewWinScrolls('http://twitter.com/share?url=https://www.cashbackdeals.de/u/481925/cashback/deal-banana-de.php&text=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 5,00% CashCoins bei Deal Banana. Verdiene extra Geld und bekomme direkt 7,50 CashCoins.'), 'Share on Twitter', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-twitter-small.png" alt="Auf Twitter teilen"/>
                                        </a>
                                        <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/deal-banana-de.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 5,00% CashCoins bei Deal Banana.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                                        </a>
                                    </div>
                        ...
                        <li>
                            <div class="dailydeal_box ">
                                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '3,00%', storeName: 'JBL.com', urlKey: 'jbl-com', imgUrl: 'https://static.orangebuddies.nl/image/stores/58362.jpg', itemId: '7004973', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span class="dailydeal">
                                        <img src="https://orangebuddies.vault.ecloud.co.uk/dailydeals/7004973.png" alt="dagdeal"/>
                                    </span>
                                </a>
                                <div class="price-bg">
                                    <span>€299,00
                                ...
                                <span class="store-logo">
                                    <img src="https://static.orangebuddies.nl/image/stores/58362.jpg" alt="JBL.com" width="120" height="60"/>
                                </span>
                                <p>JBL PartyBox 200 generalüberholt Black</p>
                                <a class="various button" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '3,00%', storeName: 'JBL.com', urlKey: 'jbl-com', imgUrl: 'https://static.orangebuddies.nl/image/stores/58362.jpg', itemId: '7004973', itemType: 'dailydeal', isCbkDay: '0'})">
                                    <span>3,00% extra CashCoins</span>
                                </a>
                                <div class="shareWraperToggle">
                                    <div class="shareIconsToggle">
                                        <a class="tellfriend" href="#inline_tellafriends" onClick="loadPopup('.tellfriend', '800', '550', 'tellafriends');
                    showTellafriendForm();">
                                        ...
                                        <a href="#" onClick="javascript: NewWinScrolls('http://twitter.com/share?url=https://www.cashbackdeals.de/u/481925/cashback/jbl-com.php&text=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 3,00% CashCoins bei JBL.com. Verdiene extra Geld und bekomme direkt 7,50 CashCoins.'), 'Share on Twitter', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-twitter-small.png" alt="Auf Twitter teilen"/>
                                        </a>
                                        <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925/cashback/jbl-com.php&name=' + encodeURIComponent('Bekomme genau wie ich (bis zu) 3,00% CashCoins bei JBL.com.') + '&picture=https://static.orangebuddies.nl/image/stores/77259.jpg&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450);
                return false;">
                                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook-small.png" alt="Auf Facebook teilen"/>
                                        </a>
                                    </div>
                    ...
                    <span class="home-readmore">
                        <a href="/shops/dailydeals-service.php">Weitere Tagesangebote</a>
                    </span>
                </div>
                <!-- start shops -->
                <div class="shop-category-shops">
                    <div id="brands-popular" class="clearfix">
                        ...
                        <div class="home-shopbanners  clearfix">
                            <div class="bx-wrapper">
                                <ul class="new_stores popular_stores">
                                    <li>
                                        <a href='/cashback/tfbank-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/102381.jpg" alt="TFBank"/>
                                            <div class="popular_store-name">TFBank</div>
                                            <div class="popular_store_cashback">25,00 CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/darlehen-einfach-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/102267.jpg" alt="darlehen-einfach.de"/>
                                            <div class="popular_store-name">darlehen-einfach.de</div>
                                            <div class="popular_store_cashback">0,00 CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/multilotto-net.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/102271.jpg" alt="Multilotto.net"/>
                                            <div class="popular_store-name">Multilotto.net</div>
                                            <div class="popular_store_cashback">2,00 CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/flug-verspaetetde.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/102246.jpg" alt="Flug-Verspaetet.de"/>
                                            <div class="popular_store-name">Flug-Verspaetet.de</div>
                                            <div class="popular_store_cashback">7,00 CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/fluege-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/102060.jpg" alt="fluege.de"/>
                                            <div class="popular_store-name">fluege.de</div>
                                            <div class="popular_store_cashback">2,50 CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/travelscout24-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101938.gif" alt="TravelScout24"/>
                                            <div class="popular_store-name">TravelScout24</div>
                                            <div class="popular_store_cashback">bis zu 2,00 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/viagogo-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101944.jpg" alt="viagogo"/>
                                            <div class="popular_store-name">viagogo</div>
                                            <div class="popular_store_cashback">bis zu 3,50 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/ray-ban-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101947.jpg" alt="Ray-Ban"/>
                                            <div class="popular_store-name">Ray-Ban</div>
                                            <div class="popular_store_cashback">4,50 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/klebefieber-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101961.jpg" alt="Klebefieber.de"/>
                                            <div class="popular_store-name">Klebefieber.de</div>
                                            <div class="popular_store_cashback">2,50 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/finanzcheck-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101964.jpg" alt="Finanzcheck.de"/>
                                            <div class="popular_store-name">Finanzcheck.de</div>
                                            <div class="popular_store_cashback">1,00 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/polo-motorrad-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101967.jpg" alt="POLO Motorrad"/>
                                            <div class="popular_store-name">POLO Motorrad</div>
                                            <div class="popular_store_cashback">bis zu 2,50 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/bolf-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101970.jpg" alt="Bolf"/>
                                            <div class="popular_store-name">Bolf</div>
                                            <div class="popular_store_cashback">1,89 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/herrenausstatter-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101937.gif" alt="herrenausstatter.de"/>
                                            <div class="popular_store-name">herrenausstatter.de</div>
                                            <div class="popular_store_cashback">bis zu 6,00 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/phase-eight-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101901.jpg" alt="Phase Eight"/>
                                            <div class="popular_store-name">Phase Eight</div>
                                            <div class="popular_store_cashback">4,00 % CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/leuchtenland-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/101884.jpg" alt="Leuchtenland"/>
                                            <div class="popular_store-name">Leuchtenland</div>
                                            <div class="popular_store_cashback">2,50 CashCoins</div>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <span class="home-readmore">
                            <a href="/shops/newshops.php">Alle neuen Shops ansehen</a>
                        </span>
                        ...
                        <div class="home-shopbanners  clearfix">
                            <div class="bx-wrapper">
                                <ul class="new_stores popular_stores">
                                    <li>
                                        <a href='/cashback/dress-for-less.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/46864.jpg" alt="dress-for-less"/>
                                            <div class="popular_store-name">dress-for-less</div>
                                    ...
                                    <li>
                                        <a href='/cashback/groupon-shopping.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/7245.jpg" alt="Groupon Shopping"/>
                                    ...
                                    <li>
                                        <a href='/cashback/o2-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/90640.jpg" alt="O2"/>
                                    ...
                                    <li>
                                        <a href='/cashback/tarifcheck24.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/8021.jpg" alt="TARIFCHECK"/>
                                    ...
                                    <li>
                                        <a href='/cashback/saturn.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/10414.jpg" alt="SATURN"/>
                                    ...
                                    <li>
                                        <a href='/cashback/vodafone-mobilfunk.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/7701.jpg" alt="Vodafone (Mobilfunk & Data)"/>
                                            <div class="popular_store-name">Vodafone (Mobilfunk &Data)</div>
                                            <div class="popular_store_cashback">bis zu 91,00 CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/medpex.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/24516.jpg" alt="medpex"/>
                                            <div class="popular_store-name">medpex</div>
                                            <div class="popular_store_cashback">2,00 CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/deutsche-postbank.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/8164.jpg" alt="Postbank"/>
                                            <div class="popular_store-name">Postbank</div>
                                            <div class="popular_store_cashback">bis zu 63,50 CashCoins</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href='/cashback/vexcash.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/53664.jpg" alt="Vexcash"/>
                                            <div class="popular_store-name">Vexcash</div>
                                            <div class="popular_store_cashback">bis zu 12,50 CashCoins</div>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="home-shopbanners  clearfix">
                            <div class="bx-wrapper">
                                <ul class="new_stores popular_stores">
                                    <li>
                                        <a href='/cashback/meinelampe-de.php'>
                                            <img src="https://static.orangebuddies.nl/image/stores/24523.gif" alt="MeineLampe.de"/>
                                            <a href="#inline_store_visit" class="button code various" style="float: none;" data-vcode="47560" onclick="loginFancyPopUP({cashback: '3,00 %', storeName: 'MeineLampe.de', urlKey: 'meinelampe-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/24523.gif', itemId: '47560', itemType: 'voucher', code: 'etcnews',isCbkDay: '0', voucher_url_key : 'meinelampe-gutschein-5'})">
                                            ...
                                            <div class="code_box_wrap" style="display: none; clear: both; float: none; margin-top: 5px;" data-vcode-show="47560">
                                                <div class="code-box" style="width:auto; height:auto;">etcnews
                    </div>
                                            </div>
                                ...
                                <ul class="blogslider">
                                    <li>
                                        <div class="BlogBox">
                                            <div class="BolgPic">
                                                <div id="block-imgRes">
                                                    <a href="/news/und-die-gewinner-sind">
                                                        <img src="https://static.orangebuddies.nl/image/blogs/thumb_blog_5491.jpg" id="image1" class="image" alt="und-die-gewinner-sind"/>
                                                    </a>
                                                </div>
                                                <div class="ImgTxt">
                                                    <a href="/news/und-die-gewinner-sind">Und die Gewinner sind ..</a>
                                                </div>
                                            </div>
                                            <div class="blogPostDes">
                                                <div class="PostDes">
                                                    <p>Hast du bei unserem Jahresgewinnspiel mitgemacht und bist neugierig ob du zu den glücklichen Gewinnern zählst?  

	Hier...</p>
                                                    <p>
                                                        <a href="/news/und-die-gewinner-sind">Hier mehr lesen</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="BlogBox">
                                            <div class="BolgPic">
                                                <div id="block-imgRes">
                                                    <a href="/news/sicher-dir-jetzt-die-besten-sale-angebot">
                                                        <img src="https://static.orangebuddies.nl/image/blogs/thumb_blog_3394.jpg" id="image1" class="image" alt="sicher-dir-jetzt-die-besten-sale-angebot"/>
                                                    </a>
                                                </div>
                                                <div class="ImgTxt">
                                                    <a href="/news/sicher-dir-jetzt-die-besten-sale-angebot">Auf die Plätze, fertig, SALE!</a>
                                                </div>
                                            </div>
                                            <div class="blogPostDes">
                                                <div class="PostDes">
                                                    <p>Weihnachten ist nun schon leider vorbei. Aber es gibt trotzdem keinen Grund zur Traurigkeit, denn jetzt hauen viele unserer...</p>
                                                    <p>
                                                        <a href="/news/sicher-dir-jetzt-die-besten-sale-angebot">Hier mehr lesen</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="BlogBox">
                                            <div class="BolgPic">
                                                <div id="block-imgRes">
                                                    <a href="/news/and-the-winner-is-">
                                                        <img src="https://static.orangebuddies.nl/image/blogs/thumb_blog_5482.jpg" id="image1" class="image" alt="and-the-winner-is-"/>
                                                    </a>
                                                </div>
                                                <div class="ImgTxt">
                                                    <a href="/news/and-the-winner-is-">And the winner is ..</a>
                                                </div>
                                            </div>
                                            <div class="blogPostDes">
                                                <div class="PostDes">
                                                    <p>Hast du bei unserem Gewinnspiel von O2  mitgemacht und bist neugierig ob du der oder die glückliche GewinnerIn bist?  ...</p>
                                                    <p>
                                                        <a href="/news/and-the-winner-is-">Hier mehr lesen</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="BlogBox">
                                            <div class="BolgPic">
                                                <div id="block-imgRes">
                                                    <a href="/news/mitbieten-und-tolle-preise-gewinnen">
                                                        <img src="https://static.orangebuddies.nl/image/blogs/thumb_blog_5469.jpg" id="image1" class="image" alt="mitbieten-und-tolle-preise-gewinnen"/>
                                                    </a>
                                                </div>
                                                <div class="ImgTxt">
                                                    <a href="/news/mitbieten-und-tolle-preise-gewinnen">Mitbieten und tolle Preise gewinnen!</a>
                                                </div>
                                            </div>
                                            <div class="blogPostDes">
                                                <div class="PostDes">
                                                    <p>Neu und exklusiv nur für Mitglieder: Jetzt bei Auktionen mitbieten und dabei tolle Preise ersteigern!  
	...
	 ...</p>
                                                    <p>
                                                        <a href="/news/mitbieten-und-tolle-preise-gewinnen">Hier mehr lesen</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="BlogBox">
                                            <div class="BolgPic">
                                                <div id="block-imgRes">
                                                    <a href="/news/neues-jahr-neues-glueck">
                                                        <img src="https://static.orangebuddies.nl/image/blogs/thumb_blog_5466.jpg" id="image1" class="image" alt="neues-jahr-neues-glueck"/>
                                                    </a>
                                                </div>
                                                <div class="ImgTxt">
                                                    <a href="/news/neues-jahr-neues-glueck">Neujahrslotterie: Neues Jahr - neues Glück</a>
                                                </div>
                                            </div>
                                            <div class="blogPostDes">
                                                <div class="PostDes">
                                                    <p>Neujahrslotterie - mitmachen &gewinnen!

	Feiere das neue Jahr mit unserer Neujahrslotterie und gewinne fantastische Preise!...</p>
                                                    <p>
                                                        <a href="/news/neues-jahr-neues-glueck">Hier mehr lesen</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="BlogBox">
                                            <div class="BolgPic">
                                                <div id="block-imgRes">
                                                    <a href="/news/gewinne-eine-von-3-feel-good-boxen-von-berlin-organics">
                                                        <img src="https://static.orangebuddies.nl/image/blogs/thumb_blog_5421.jpg" id="image1" class="image" alt="gewinne-eine-von-3-feel-good-boxen-von-berlin-organics"/>
                                                    </a>
                                                </div>
                                                <div class="ImgTxt">
                                                    <a href="/news/gewinne-eine-von-3-feel-good-boxen-von-berlin-organics">Gewinne eine von 3 Feel Good Boxen von Berlin Organics!</a>
                                                </div>
                                            </div>
                                            <div class="blogPostDes">
                                                <div class="PostDes">
                                                    <p>Gewinne eine von 3 Feel Good Boxen von Berlin Organics im Wert von über 70€!

	Das Ende des Jahres kommt mit großen...</p>
                                                    <p>
                                                        <a href="/news/gewinne-eine-von-3-feel-good-boxen-von-berlin-organics">Hier mehr lesen</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <script>
                ...
                $('#time2').countdown("2019-01-20 08:44:12", function(event) {
                    if (event.type == 'stoped') {
                        $("#time2").hide();
                    } else {
                        var $this = $(this).html(event.strftime('' + '%D:' + '%H:' + '%M:' + '%S'));
         ...
         ">
                &nbsp;
                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '5,00%', storeName: 'NA-KD.com', urlKey: 'na-kd-com', imgUrl: 'https://static.orangebuddies.nl/image/stores/78132.jpg', itemId: '0', bannerId: '37610', isCbkDay: '0'})">
                    <img src="https://static.orangebuddies.nl/image/banners/37610-Normal.jpg" alt="NA-KD.com">
                </a>
            </div>
        </div>
        <!-- End Content -->
...
<div id="footer">
    <div class="FooterDetail">
        <div class="FooterQuickLink">
            <div class="FooterMenu">
                <ul class="grid effect-1" id="grid">
                    <li>
                        <p>Angebote</p>
                        <p class="FooterMenuLink">
                            <a href="/shops/dailydeals-service.php" target="_self">Tagesangebote</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/shops/deals.php?type=kortingscodes" target="_self">Rabattcodes </a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/shops/deals.php?type=new" target="_self">Neue Angebote</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/shops/deals.php?type=tip" target="_self">Beliebte Angebote</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/shops/deals.php?type=special" target="_self">Sonderangebote</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/manufacturer-cashback/" target="_self">Cashback-Aktionen der Hersteller</a>
                        </p>
                    </li>
                    <li>
                        <p>Hilfreiche Webshop-Tipps</p>
                        <p class="FooterMenuLink">
                            <a href="/static/page.php?url_key=uitleg-shops" target="_self">Wie das Einkaufen mit Cashback funktioniert</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/page.php?url_key=uitleg-kortingscodes" target="_self">Rabattcodes und Cashback</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/shops/shops.php?url_key=all" target="_self">Suche nach Online-Shops </a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/shops/shops.php?url_key=all" target="_self">Alle Online-Shops mit Cashback</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/earn-money.php" target="_self">Alle Wege, um Geld zu verdienen</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/comparison/" target="_self">Vergleich</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/page.php?url_key=uitleg-verdien-meer" target="_self">Sofort Verdienst</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/user/cashboost-new.php" target="_self">Cashboost</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/shops/win-competition.php" target="_self">Gewinnen</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/shops/shops.php" target="_self">Gratis Cashback</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/blog/" target="_self">Blog</a>
                        </p>
                    ...
                    <li>
                        <p>Hilfe</p>
                        <p class="FooterMenuLink">
                            <a href="/static/faq.php" target="_self">FAQ </a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/user/generateticket.php" target="_self">Antrag für fehlende Transaktion stellen</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/contact.php" target="_self">Anfrage stellen </a>
                        </p>
                    </li>
                    <li>
                        <p>Tools</p>
                        <p class="FooterMenuLink">
                            <a href="/static/mobile-app.php" target="_self">App installieren</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/toolbar.php" target="_self">Cashback-Melder downloaden </a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/tech-check" target="_self">PC Check</a>
                        </p>
                    </li>
                    <li>
                        <p>CashbackDeals.de</p>
                        <p class="FooterMenuLink">
                            <a href="/static/about-us/" target="_self">Über uns</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/affiliates/" target="_self">Affiliates</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/advertise/" target="_self">Werben</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/sitemap/" target="_self">Sitemap </a>
                        </p>
                    </li>
                    <li>
                        <p>Allgemein</p>
                        <p class="FooterMenuLink">
                            <a href="/static/terms-and-conditions/" target="_self">AGB</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/cookies/" target="_self">Cookies</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/privacy" target="_self">Datenschutz</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/disclaimer/" target="_self">Disclaimer</a>
                        </p>
                        <p class="FooterMenuLink">
                            <a href="/static/impressum/" target="_self">Impressum</a>
                        </p>
                    </li>
                </ul>
        ...
        <div class="FollowUs">
            ...
            <div class="SocialIcons">
                <a target="_blank" href="https://www.youtube.com/channel/UCiATlA546p52hrcltj3DIBQ">
                    <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/follow-us-youtube.gif" alt="Youtube" class="IconAdj">Folge uns auf YouTube
                </a>
            </div>
            <div class="SocialIcons">
                <a target="_blank" href="https://www.facebook.com/www.cashbackdeals.de/">
                    <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/follow-us-facebook.gif" alt="Facebook" class="IconAdj">Like unsere Facebook-Seite
                </a>
            </div>
            <div class="rating">
    ...
    <div class="FootSection2">
        <div class="OrangeLogo">
            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/OrangeBuddies-logo.png" alt="OrangeBuddies">
        </div>
        <div class="copyRight01">
            <p>
                &copy;2009-2019 orangebuddies.com | Powered by : <a href="http://www.orangebuddies.com" target="_blank">OrangeBuddies Media</a>
            </p>
...
<div class="BottomBar" id="BottomBar">
    <div class="crossBtn">
        <img onclick="closeDealBar('BottomBar')" style="cursor: pointer;" src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/crossBtn.png" alt="Close" width="26" height="26"/>
    </div>
    <div class="BarCont">
        <div class="ParentBar">
            <div class="BarLogo">
                <img src="https://static.orangebuddies.nl/image/stores/21536.jpg" alt="RandomDeal" class="LogoRes"/>
            </div>
            <div class="BarCash">bis zu 27,50  CashCoins</div>
            <div class="BarTxt">Urlaub.de: 75 EUR Gutscheincode</div>
            <div class="BarTxt2">
                Code:<strong>URLAUB75</strong>
            </div>
            <div class="ShopNow">
                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '27,50 ', storeName: 'Urlaub.de', urlKey: 'urlaub-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/21536.jpg', isCbkDay: '1', itemId: '512622'})">Zum Online-Shop
                            </a>
            </div>
        </div>
    </div>
...
<div class="rightBanner main_banner">
    <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '17,50 ', storeName: 'Santander Consumer Bank', urlKey: 'santander-consumer-bank-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/96620.jpg', itemId: '0', bannerId: '35649', isCbkDay: '1'})" title="Santander Consumer Bank">
        <img class="main_sidebanner" width="120" height="400" src="https://static.orangebuddies.nl/image/banners/35649-SkyScraperWrapper.jpg" alt="Santander Consumer Bank"/>
    </a>
    <img src="" width="0" height="0" style="display:none"/>
</div>
</section>
<!-- bodyWrapper section end -->
...
<script type="text/javascript">
    ...
    function initAlert() {
        ...
        PeanutLabsAlert.initialize({
            ...
            debugEnabled: true,
            // Have debug messages logged to the consolse.
            hideAfter: 15,
            // Makes the alert hide after 4 seconds. Can be left out, and will default to 10 seconds.
            iframeURL: 'https://www.cashbackdeals.de//onlinepanel-pl',
            // This URL needs to be changed to the url for the iframe.
            positionHorizontal: 'right',
            positionVertical: 'bottom',
            currencyName: 'Peanuts',
            server: 'https://api.peanutlabs.com',
            logoURL: 'https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16//assets/osn-icon.png',
            //'https://ii.peanutlabs.com/PL_Logo.png'
...
<script type="text/javascript">
    ...
    function updateWishList(id, type, selection) {
        ...
        ////////////////////// classes used///////////////
        var enableClsFav = 'fa-heart';
        //enable fav class
        var disableClsFav = 'fa-heart-o';
        //disable fav class
        var enableClsFavBell = 'fa-bell';
        //enable mail subscribe class
        var disableClsFavBell = 'fa-bell-slash';
        //disable mail subscribe class
        var favId = 'favStore';
        ...
        if (selection == 'all') {
            //only work for mail notify bell subscribe
            var favElementNotifyBell = $("." + commonClsNotify);
        } else {
            var favElementHeart = $("#" + favId + id);
            //add favourite element selection need to update
            var favElementNotifyBell = $("#" + favNotifyId + id);
            //subscribe element selection need to update
        }

        if (type == 'addRemoveFav') {
            //if user clicked on add fav heart icon
            if (favElementHeart.hasClass(enableClsFav)) {
                action = 'remove';
            } else {
                action = 'add';
            }
        } else if (type == 'updateAlerts') {
            //if user clicked on fav store mail bell icon notification

            if (selection == 'all') {
                // if click enable all and disable all mail notifictaions
                if ($("#" + subAllFavId).is(':checked')) {
                    action = '1';
                } else {
                    action = '0';
                }
            } else {
                if (favElementNotifyBell.hasClass(disableClsFavBell)) {
                    action = '1';
                } else if (favElementNotifyBell.hasClass(enableClsFavBell)) {
                    action = '0';
                }
            }
        }
    ...
    function rewardCpcClick(key, pIdx) {
        if (typeof key !== "undefined") {
            ...
            window.open('/visit/' + key + '.php?cm=1', "_blank");
            // cm=1 mean don't show the exit page;
            $('.cpc-' + pIdx).remove();
        } else {
            errMsg = "Keine Ergebnisse gefunden";
        }
    ...
    function adventSaveClick(myObj) {
        ...
        } else {//  console.log("Save No click!");
        }
    ...
    function loginFancyPopUP(myObj) {
        ...
        if (myObj.itemType == 'product') {
            ...
            // hide any previously shown voucher code box
    ...
    function loadPopup(className, width, height, targetedHtmlId) {
        ...
        var btnTemplate = '';
        if ('Shoppingandmore34@hotmail.com') {
            ...
            btnTemplate = '<a title="Close" class="fancybox-item fancybox-close fancybox-close-universal" href="javascript:;"></a>';
    ...
    function shareTweet(eleNo, userid, linkurl, text, sid) {
        ...
        var myurl = linkurl;
        var mytext = text;
        var url = "https://twitter.com/intent/tweet" + "?url=" + encodeURIComponent(myurl) + "&text=" + encodeURIComponent(mytext);
    ...
    function startIntervalCashback(tabs) {
        return setInterval(function() {
            tabs.each(function(idx, ele) {
                // iteration through each element
                if (!$(ele).hasClass('active')) {
                    // if element is not active then make that active and display his respective container (Trending or CashbackDay)
                    $(ele).addClass('active');
    ...
    $(document).ready(function() {
        ...
        if (typeof tabs !== "undefined") {
            var intrValObj = '';
            // var will be used as a global variable for interval instance
            if (tabs.length > 1) {
                // interval will only work if the number of tabs are more then one.
                intrValObj = startIntervalCashback(tabs);
                // start interval
                $('.homehome-banners').mouseenter(function() {
                    clearInterval(intrValObj);
                    // clear interval
                }).mouseleave(function() {
                    intrValObj = startIntervalCashback(tabs);
                    //restart interval
    ...
    $(document).ready(function($) {
        ...
        $('form').each(function(index, value) {
            if (value.name != 'sort-shopsForm' && value.name != 'itune-form' && value.name != 'cadeous-cards') {
                token = 'e2176d34be65d20fcc4322f60c067c178d12c127';
            ...
            if ($('#alertbar-install-bfr').length > 0 && $('#alertbar-install-aftr').length > 0) {
                ...
                if (typeof googleExtLinkObj != 'undefined' && googleExtLinkObj != null && googleExtLinkObj != '') {
                    ...
                    if (googleExtID) {
                        ...
                        if (brw == 'chrome') {
                            chrome.runtime.sendMessage(googleExtID, {
                                message: "isInstalled"
                            }, function(reply) {
                                if (reply) {
...
*/
    ...
    function securityCheck(obj) {
        ...
        if (obj.passwordNewflow !== "undefined" && obj.passwordNewflow == 1) {
            var txt_login_pass = "Wachtwoord vergeten? <a href='/user/account-password.php?mode=request'>Klik hier</a>";
            $('#testchange').html(txt_login_pass);
        }
    ...
    function whatsappCheckPopup() {
        // whatsapp popup
        loadPopupWhatsapp('.various', '775', '410');
    }

    function securityCheckPopup() {
        // cashout authentication popup
...
<script>
    ...
    if ($('#Cashbackday').length > 0) {
        ...
        $('#counterClock').countdown(nextDay.toDate(), function(event) {
            var $this = $(this).html(event.strftime('' + '<div class="time CounterNum">%H</div><div class="CounterGap">:</div>' + '<div class="time CounterNum">%M</div><div class="CounterGap">:</div>' + '<div class="time CounterNum">%S</div>'));
        });
        ...
        if (counterClockz.length > 0) {
            counterClockz.each(function(idx) {
                ...
                $('.clokctner-' + idx).countdown(nextDay.toDate(), function(event) {
                    $('.clokctner-' + idx).html(event.strftime('' + '<div class="time CounterNum">%H</div><div class="CounterGap">:</div>' + '<div class="time CounterNum">%M</div><div class="CounterGap">:</div>' + '<div class="time CounterNum">%S</div>'));
                });
            });
        }
    }
    ...
    $('[data-vcode]').click(function() {
        ...
        $('[data-vcode="' + vcodeID + '"]').hide();
        // hide button
        $('[data-vcode-show="' + vcodeID + '"]').show();
        // show voucher code by ID
    });
...
<div style="display:none;">
    <a class="various" href="#inline_store_reg" id="regPop">visit</a>
    <a class="various" href="#inline_store_visit" id="visitPop">register</a>
...
<div id="inline_adventCal" style="display:none;">
    <div class="popup_table">
        <a href="https://www.cashbackkorting.nl/visit/bol-com.php" id="click">
            <img src="" id="advent_imgurl">
        </a>
    </div>
</div>
            ...
            <div class="popup-content-padding clearfix">
                    ...
                    <div id="tabs" class="tabs">
                        ...
                        <div class="content">
                            <section id="section-1">
                                <form action="https://www.cashbackdeals.de/user/register.php" method="post" enctype="application/x-www-form-urlencoded" name="form1" target="_self">
                                    <!-- please remove ID or rename it -->
                                    <span class="popup-field" id="first_name_v">
                                        <input type="text" class="popup-field-input text-input textfield" id="first_name" name="first_name" autocomplete="given-name">
                                        <!-- new class -->
                                        <i class="fa fa-check-circle validMsg" aria-hidden="true"></i>
                                    </span>
                                    <span class="popup-field" id="last_name_v">
                                        <input type="text" class="popup-field-input text-input textfield" id="last_name" name="last_name" autocomplete="family-name">
                                        <!-- new class -->
                                        <i class="fa fa-check-circle validMsg" aria-hidden="true"></i>
                                    </span>
                                    <span class="popup-field" id="email_v">
                                        <input type="text" class="popup-field-input" id="email" name="email" autocomplete="email">
                                        <!-- new class -->
                                        <i class="fa fa-check-circle validMsg" aria-hidden="true"></i>
                                    </span>
                                    <span class="popup-field" id="password_v">
                                        <input type="text" name="passtip0" id="passtip0" value="Passwort" class="popup-field-input" onfocus="showPass(document.getElementById('passwordregister'), this)">
                                        <!-- new class -->
                                        <input type="password" name="password" id="passwordregister" class="popup-field-input" style="display: none;" onblur="hidePass(this, document.getElementById('passtip0'))" autocomplete="off">
                                        <!-- new class -->
                                        <i class="fa fa-check-circle validMsg" aria-hidden="true"></i>
                                    </span>
                                    ...
                                    <span class="popup-conditions">
                                        <span id="agree_v">
                                            <input name="agree" value="1" type="checkbox" class=" checkbox" id="agree">
                                        </span>
                                        <label>
                                            Ich stimme den <a href="javascript:void(0)" onclick="termsCondition()">AGB</a>
                                            und der <a href="javascript:void(0)" onclick="Privacy()">Datenschutzerklärung</a>
                                            von CashbackDeals zu. Ich bin 18+ und gebe die Erlaubnis täglich bis zu 4 Mal E-Mails zu erhalten, welche Werbung enthalten können. Du wirst mit CashCoins für das Klicken der meisten E-Mails belohnt. 
                                        </label>
                                    </span>
                                    <span class="popup-signup-button">
                                        <button class="popbtn" type="submit" value="Melde dich gratis an">
                                            <span>Melde dich gratis an</span>
                                        </button>
                                    </span>
                            ...
                            <section id="section-2">
                                <form action="https://www.cashbackdeals.de/user/login.php" method="post" enctype="application/x-www-form-urlencoded" name="form2" target="_self">
                                    <!-- please remove ID or rename it -->
                                    ...
                                    <span class="popup-conditions">
                                        <label class="remember" for="rememberpassLogin">
                                            <input type="checkbox" name="rememberpass" id="rememberpassLogin" style="width: 20px" value="1"/>Passwort merken
                                        </label>
                                    </span>
                                    <span class="popup-login-button">
                                        <button class="popbtn" type="submit" value="Einloggen">
                                            <span>Einloggen</span>
                                        </button>
                                    </span>
                                    <span class="popup-pass">
                                        <a href="/user/forgot-password.php">Passwort vergessen? </a>
                                    </span>
                ...
                <div class="popup-content-left">
                    <span class="popup-advantages">
                        ...
                        <ul>
                            <li>10 Wege, Cash zu verdienen</li>
                            <li>7,50 CashCoins geschenkt</li>
                            <li>Höchstes Cashback</li>
                            <li>3340 Webshops</li>
                            <li>100% gratis</li>
                        </ul>
                    </span>
...
<div id="inline_store_visit" style="display:none;">
    <div class="popup">
        <div class="popup-top">
            <img src="" id="store_imgurl" class="popup-banner-img">
            <div class="heading popup-heading-txt">
            <!-- short description -->
            </div>
        </div>
        <div class="popup-info clearfix">
            <span class="popup-info-left">
                <span>CashCoins</span>
                <span id="store_cashback_range"></span>
            </span>
            <span class="popup-info-center">
                <span>Extra Bedingungen</span>
                <span id="extra_conditions">
                <!-- extra info -->
                </span>
            </span>
            <span class="popup-info-right pc">
                <span>PC Check</span>
                <span id="pc_check_status"></span>
            </span>
        </div>
        <div class="popup-advice clearfix">
            <div class="popup-advice-left">
                <i class="fa fa-exclamation-triangle"></i>
            </div>
            <div class="popup-advice-right alert-msg">
            <!-- full description -->
            </div>
        </div>
        ...
        <span class="popup-button">
            <a id="store_visit_link" href="" target="_blank" onclick="closeFB()">
                <span id="store_visit_text"></span>
            </a>
        </span>
        <span class="popup-back">
            <a id="store_detail_link" href="">Zurück zu CashbackDeals.de</a>
        </span>
        <div class="popup-deals" style="display:none;">
            <p>
                Gib deine Bestellung direkt auf und besuche <strong>keine</strong>
                anderen Webseiten während deines Ankaufs.<br/>Dein Ankauf wird innerhalb von 48 Stunden in deinem Konto sichtbar.
            </p>
...
<div class="bg_flat" id="confirmBrokenLink" style="display:none;">
    <div style="position: relative; top: 20px; font-size: 12px; width: 90%; text-align: justify;">
        <h2>Funktioniert der Link nicht mehr?</h2>
        <br/>
        Bitte überprüfe, ob der Link zum Webshop auch nicht in einem anderen Internet-Browser funktioniert. Wenn der Link auch dort nicht funkioniert, kannst du hier auf "Bestätigen" klicken und wir werden so schnell wie möglich nach der Ursache suchen.<br>
        <br/>
        Klicke auf das Kreuz oben rechts, wenn der Link <br>doch funktioniert. 
    </div>
    <div id="genStoreLink" style="display:none;"></div>
    <div style="float:left; margin-top:20px;">
        <a href="javascript:;" onclick="javascript: window.location = document.getElementById('reported-link').href;" class="fancybox_btn">
...
<div id="inline_account_move_SBS" style="display: none;">
    <div class="popup continue-sbs">
        ...
        <p class='sbsPopupReplace'>
            Du hast keine Lust mehr, E-Mails von uns zu erhalten, willst aber weiterhin mit dem höchsten Cashback in Deutschland shoppen? Shoppe weiter über unsere neue Webseite %SBS_PARTNER% und erhalte den höchsten Cashback für deine Online-Einkäufe. Klicke auf <B>JA</b>
            und wir erstellen dir ein neues kostenloses Mitgliedskonto. Nicht interessiert? Dann klicke auf <B>NEIN</B>
            und wir schließen dein Mitgliedskonto. Dein Guthaben von <B>19,980 CashCoins </B>
            wird gelöscht.
        </p>
        <span class="popup-button">
            <a href="javascript:void(0);" onclick="moveAccountToSBS({sbsPartner: ''});">
                <span id="">Ja, bitte</span>
            </a>
            <a href="javascript:void(0);" onclick="closeAccountCBK();">
                <span id="">Nein, danke</span>
            </a>
        </span>
        <p>
            <a target="_new" href="https://">
                <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/sbs-move-banner.gif"/>
            </a>
        </p>
    </div>
</div>
<div id="inline_cashout_auth" style="display:none;">
    <div class="EmailPopup">
        ...
        <div class="signup-form-pass SmTxt">
            Passwort ändern? <a href="/user/detail/account.php">Klicke hier</a>
        </div>
        <div>
            <button class="popbtn" type="button" onclick="closePopup();">
                <span>Abbrechen</span>
            </button>
            <button class="popbtn" type="button" value="Submit" onclick="passwordAuth();">
                <span>Versenden</span>
            </button>
        </div>
    </div>
...
<div id="inline_whatsapp" style="display:none;">
    <div class="EmailPopup">
        ...
        <br>
        <div id='whatsAppNoNote' style="margin-top:10px"></div>
        <div class="inputBox">
            <div id='data'></div>
            ...
            <input type="hidden" name="numbertype" id="numbertype" value=""/>
            <br/>
            ...
            <span id="valid_phone_number">
                <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/licheck.png" title="Valid" alt="Valid" class="validMsg" border="0">
            </span>
...
<div id="inline_tellafriends" style=" padding:50px;display:none;">
    <div id="gmail" style="display: none; position:relative;"></div>
    <div id="yahoo" style="display: none; position:relative;"></div>
            ...
            <div class="popup_table">
                ...
                <div class="popup_details">
                    ...
                    <span class="popup_input">
                        <a href="https://accounts.google.com/o/oauth2/auth?client_id=938620705190-2v8o3st9hlts94gkfpk2jauo1fhb78s0.apps.googleusercontent.com&redirect_uri=https://www.cashbackdeals.de/import_contacts/google/&scope=https://www.google.com/m8/feeds/&response_type=code" target="_blank" title="GMAIL">
                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/gmail-icon.png" alt="GMAIL"/>
                        </a>
                        <a href="https://www.cashbackdeals.de/import_contacts/yahoo/getreqtok.php" target="_blank" title="Yahoo!">
                            <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/yahoo-icon.png" alt="Yahoo!"/>
                        </a>
                    </span>
                </div>
                <div class="popup_details">
                    ...
                    <span class="popup_input">
                        ...
                        <input type="text" name="friend_email" class="blurIn" id="friend_email" style="width:100%; height:20px; font-size: 10px;"/>
                    </span>
                    <span class="">
                        <div class="subject-tip-box">
                            Persönliche Nachrichten erzielen eine bessere Wirkung<img class="arrow-down" src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/referral_down.gif" alt="Referral"/>
                        </div>
                    </span>
                </div>
                <div class="popup_details">
                    ...
                    <span class="popup_input">
                        ...
                        <input type="text" name="subject" id="subject" value="zusammen Geld verdienen?" style="width:100%; height:20px;"/>
                    </span>
                </div>
                <div class="popup_details">
                    <span class="popup_label">
                        <div class="message-tip-box">
                            Diesen Text kannst du selbst ändern<img class="arrow-side" src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/referral_right.gif" alt="Referral"/>
                        </div>
                    </span>
                    <span class="popup_input">
                        <label for="message"></label>
                        <textarea name="message" id="message" cols="45" rows="8" style="width: 100%;">Hi, ich nutze CashbackDeals.de seit Kurzem und möchte diese tolle und einfache Art Geld zu verdienen gerne mit dir teilen. Melde dich an und du erhältst sofort 7,50 CashCoins Willkommens-Bonus. Viel Erfolg!</textarea>
                    </span>
                </div>
                <div class="popup_details">
...
<script type="text/javascript">
    var x = ['Vorname', 'Nachname', 'E-Mail-Adresse', 'Passwort', 'E-Mail-Adresse', 'Passwort'];
    $(document).ready(function() {
        validatePopup(x);
    });
</script>
